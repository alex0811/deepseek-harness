...
flowchart LR
  ...
  plugin_dsh_base_stale_plan_reminder["stale-plan-reminder<br/>@deepseek-ai/dsh-stale-plan-reminder"]
  cfg --> plugin_dsh_base_stale_plan_reminder
...
| `stale-plan-reminder` | `@deepseek-ai/dsh-stale-plan-reminder` |
