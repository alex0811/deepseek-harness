...
export const zh = {
  ...
  'settings.transcript.description': '控制运行中与已完成轮次的过程内容',
  'settings.transcript.normal': '标准模式',
  'settings.transcript.compact': '精简模式',
...
export const en = {
  ...
  'settings.transcript.description': 'Controls process content in running and completed turns',
